...
- **WHEN** a token moves from (1987.9, 829.1000000000001) to (2057.3456, 829.1000000000001)
- **THEN** the entry reads "moved Goblin from (1987.9, 829.1) to (2057.35, 829.1)"

#### Scenario: Whole numbers stay whole
- **WHEN** a token moves from (35, 35) to (105, 35)
- **THEN** the entry reads "moved Goblin from (35, 35) to (105, 35)"
